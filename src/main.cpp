...
static bool tryLoadSdUiFonts(GfxRenderer& r) {
  bool ok10 = sdUiFont10.loadFromMemory(MIGU1M_TERM_10, MIGU1M_TERM_10_SIZE);  // 10pt for UI + buttons
  bool ok12 = sdUiFont12.loadFromMemory(MIGU1M_TERM_12, MIGU1M_TERM_12_SIZE);  // 10pt title
