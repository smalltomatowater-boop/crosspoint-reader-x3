  ...
  static const std::vector<SettingInfo> baseList = [] {
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Toggle(StrId::STR_SUNLIGHT_FADING_FIX, &CrossPointSettings::fadingFix, "fadingFix",
                            StrId::STR_CAT_DISPLAY),
        SettingInfo::Toggle(StrId::STR_EDITOR_INVERT, &CrossPointSettings::editorInvert, "editorInvert",
                            StrId::STR_CAT_DISPLAY),
        ...
        SettingInfo::Toggle(StrId::STR_EDITOR_VI_MODE, &CrossPointSettings::editorViMode, "editorViMode",
                            StrId::STR_CAT_CONTROLS),

        // --- System ---
        SettingInfo::Enum(StrId::STR_TIME_TO_SLEEP, &CrossPointSettings::sleepTimeout,
                          {StrId::STR_MIN_1, StrId::STR_MIN_3, StrId::STR_MIN_5, StrId::STR_MIN_10, StrId::STR_MIN_15,
                           StrId::STR_MIN_30, StrId::STR_NEVER},
