...
class GfxRenderer {
 ...
 public:
  ...
  void displayWindow(uint16_t x, uint16_t y, uint16_t w, uint16_t h) const;
  ...
  // True if every codepoint of the UTF-8 text is in the font (none would be
  // drawn as the replacement glyph). False for an unknown fontId.
